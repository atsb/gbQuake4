...
#define GAME_NAME						"gbQuake4"			// appears on window titles and errors
#define GAME_ICON						"q4icon.bmp"

#define ENGINE_VERSION					GAME_NAME
...
#define	WIN32_WINDOW_CLASS_NAME			"gbQuake4"
