...
enum {
	SFLAG_EXPIRED = BIT(0),
	SFLAG_SOUNDPLAYING = BIT(1),
	SFLAG_HASMOTIONTRAIL = BIT(2),
};
...
enum {
	STFLAG_ENABLED = BIT(0),
	STFLAG_LOCKED = BIT(1),
	STFLAG_HASPARTICLES = BIT(2),
	STFLAG_HASPHYSICS = BIT(3),
	STFLAG_IGNORE_DURATION = BIT(4),
	STFLAG_INFINITE_DURATION = BIT(5),
...
enum {
	ETFLAG_HAS_SOUND = BIT(0),
	ETFLAG_USES_ENDORIGIN = BIT(1),
	ETFLAG_ATTENUATES = BIT(2),
	ETFLAG_EDITOR_MODIFIED = BIT(3),
	ETFLAG_USES_MATERIAL_COLOR = BIT(4),
	ETFLAG_ORIENTATE_IDENTITY = BIT(5),
	ETFLAG_USES_AMBIENT_CUBEMAP = BIT(6),
	ETFLAG_HAS_PHYSICS = BIT(7),
};
...
enum {
	EFLAG_LOOPING = BIT(0),
	EFLAG_HASENDORIGIN = BIT(1),
	EFLAG_ENDORIGINCHANGED = BIT(2),
	EFLAG_STOPPED = BIT(3),
	EFLAG_ORIENTATE_IDENTITY = BIT(4),
	EFLAG_AMBIENT = BIT(5),
};
